...
- Milestones treated as real wins, not small things: a senior developer
  (40+) writes his first unit test ever; another adds his first-in-career
  unit test; a Selenium workshop day becomes "first development this team
  _really_ collaborates on," credited partly to [[et-dinners|@ru_altom]]'s
  help getting started.
- Names the emotional cost candidly: "I may appear to take the jokes about
  everyone in the team hating testers well, but they actually do eat my
  morale" — and separately, "I'm sensitive to things like this as minority
  of one." She reframes it deliberately as ignorance rather than hate to
  stay functional, but the cost is real and named, not just managed away.
- A real identity wobble in April: "today I feel it's highly possible I
  stop calling myself a tester and just be a developer." Doesn't resolve
  cleanly — by December she's still identifying as a tester, but the wobble
  itself is notable given how central "tester" is to her professional
  identity elsewhere.
- Practical wins accumulate alongside the friction: fewer full-team
  fix-and-forget release crunches than the year before, a remote developer
  granted full repo access ("politics take longer than the actual
  change"), and one developer's acceptance of automated tests going from
  "two rounds of total failures" to catching a relevant bug.
- Frames the ask precisely, not as "developers should test" in the
  abstract: "I need to offer practical support to build skills we're
  missing," not just techniques.

Representative posts:
- https://twitter.com/maaretp/status/345484881914118144
- https://twitter.com/maaretp/status/399978574028877824
- https://twitter.com/maaretp/status/400972539444211713

## 2014 — [[../batches/2014|batch]]

Turns partly inward: instead of only coaxing developers to test, she
faces her own fear of the reverse — pairing on code. Attends a code
retreat "way out of my comfort zone... pairing terrifies me," names the
fear directly ("not being good enough. Needing more time and space than
others"), and blogs "Facing my fears and feeling ridiculous" afterward.
Woody Zuill's Mob Programming keynote at
[[../entities/tampere-goes-agile|Tampere Goes Agile]] gives the whole-team
collaboration theme a new practice and name; she joins his remote
"skeleton team" mob session on New Year's Eve. Coins a line that spreads
beyond her own circle: "Testers don't break your code, they break your
*illusions* about your code" (credited and quoted by Llewellyn Falco).
